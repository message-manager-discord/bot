...
uri = f"postgres://{try_get_config_var('PGUSER')}:{try_get_config_var('PGPASSWORD')}@{try_get_config_var('PGHOST')}:{try_get_config_var('PGPORT')}/{try_get_config_var('PGDATABASE')}"
